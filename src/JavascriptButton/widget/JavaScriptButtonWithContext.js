...
define([
    ...
    return declare("JavaScriptButton.widget.JavaScriptButtonWithContext", [ _WidgetBase, _TemplatedMixin ], {
        ...
        _updateRendering: function () {
			...
			if (this._contextObj !== null && this._contextObj.get(this.btnTxtFromEntity)) {
				this.theButton.innerHTML = this._contextObj.get(this.btnTxtFromEntity);
			} else {
